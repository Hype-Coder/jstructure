...
public final class Float extends primitives.Number {
    ...
    @Override
    public primitives.Float floatValue() { return new primitives.Float(f); }

    @Override
    public primitives.Double doubleValue() { return new primitives.Double(f.doubleValue()); }
