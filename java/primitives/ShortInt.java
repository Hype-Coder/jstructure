...
public final class ShortInt extends primitives.Number {
    ...
    public primitives.Float floatValue() {
        ...
        return new primitives.Float(s.floatValue());
    ...
    public primitives.Double doubleValue() {
        ...
        return new primitives.Double(s.doubleValue());
    ...
    protected Number opp() {
        ...
        return new primitives.Double(1 / this.s);
